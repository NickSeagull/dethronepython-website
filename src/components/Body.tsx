...
const Body: React.FC = () => {
  return (
    <div className='mt-40 mb-40 md:max-w-xl max-w-xs mx-auto'>
      <span>Python uruk-hai’s have conquered the AI world. They got all the ML libraries, and we’re just one more hit away from entering a new age of darkness where Python rules. We are calling all the JVM warriors to join this battle to dethrone Python once and for all!</span>
