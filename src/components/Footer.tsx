  ...
  return (
    <div>
      <div className='mt-40 md:max-w-4xl max-w-md mx-auto text-center '>
        ...
        <span className='w-1'>These projects have officially joined the cause:</span>
        <div className='mt-10'>
          <LinkBox to='' backgroundColor='black' textColor='white' icon={ArrowRightIcon}>
            <p className='text-start font-bold'>eLLMental</p>
            <p>An open-source library for Java</p>
          </LinkBox>

          <div className="relative -mt-2">
            <LinkBox to='' backgroundColor='white' textColor='black' icon={PlusIcon}>
              <p className='text-start'>
                <span className='text-start font-bold'>Want to add your JVM AI project?</span> Find us on GitHub, send a PR with your project description, and we'll vote for it!
              </p>
            </LinkBox>
          </div>
        </div>
